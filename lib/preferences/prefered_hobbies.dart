...
class PreferedHobbies extends StatefulWidget {
  const PreferedHobbies({super.key});

  @override
  State<PreferedHobbies> createState() => _PreferedHobbiesState();
}

class _PreferedHobbiesState extends State<PreferedHobbies>
    ...
    try {
      await FirebaseFirestore.instance.collection('users').doc(user.uid).set({
        'preferredHobbies': {
          ...
          'other': selectedHobbies.contains("Other") ? otherText : null,
        },
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 10,
                      runSpacing: 10,
                      children: hobbyOptions.map((option) {
                        final isSelected = selectedHobbies.contains(option);
                        return ChoiceChip(
                          label: Text(
                            option,
                            style: GoogleFonts.poppins(
